...
function updateSettingsMenuPosition() {
  ...
  // Place the panel over the heading area instead of using a hard-coded
  // landscape offset. This stays stable when iPad orientation changes.
  const desiredLeft = titleRect.right - menuWidth;
  ...
  const desiredTop = titleRect.top - 4;
